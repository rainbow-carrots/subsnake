...
class MIDIControl(QWidget):
    ...
    def __init__(self):
        ...
        layout.addWidget(cc_label, 0, 0)
        layout.addWidget(self.cc_select, 0, 1)
        layout.addWidget(module_label, 0, 2)
        layout.addWidget(self.module_select, 0, 3)
        layout.addWidget(param_label, 0, 4)
        layout.addWidget(self.param_select, 0, 5)
