...
walk_test = np.zeros((16, 2), dtype=np.float32)
walk_test_state = np.zeros((1, 2), dtype=np.float32)
...
WrappedOsc.generate_sine(osc_test, np.zeros((16, 2), dtype=np.float32), walk_test, mod_test, mod_test, mod_test, 0, 0, 0)
WrappedOsc.polyblep_saw(osc_test, np.zeros((16, 2), dtype=np.float32), walk_test, mod_test, mod_test, mod_test, 0, 0, 0)
WrappedOsc.polyblep_pulse(osc_test, np.zeros((16, 2), dtype=np.float32), osc2_test, 0.5, walk_test, mod_test, mod_test, mod_test, mod_test, 0, 0, 0, 0)
